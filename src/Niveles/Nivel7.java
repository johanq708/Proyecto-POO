 ...
 */
public class Nivel7 extends Tablero{
    private Obstaculo obstaculo71;
    private Movible obstaculo72;
    
    public Nivel7(){
        bala=new Bala(5,235,50,50);
        blanco=new Blanco(1000,300,64,44,bala);
        this.obstaculo71=new Obstaculo(350,150,120,160,bala);
        this.obstaculo72=new Movible(200,100,82,100,bala);
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawImage(muro, obstaculo71.getX(), obstaculo71.getY(),obstaculo71.getAncho(),obstaculo71.getAlto(), this);
        g.drawImage(ave, obstaculo72.getX(), obstaculo72.getY(),obstaculo72.getAncho(),obstaculo72.getAlto(),obstaculo72.getS(),0,obstaculo72.getS()+182,150, this);
        dibujar(g,200,220);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        bala.disparar();
        blanco.punteria();
        obstaculo71.punteria();
        obstaculo72.mover();
        obstaculo72.punteria();
    ...
    public void cambiar(){
        if(blanco.isDiob()==true||blanco.isDiom()==true||blanco.isNodio()==true||obstaculo71.isNodio()==true||obstaculo72.isNodio()){
            this.cambio=true;
        }
    }    
}
