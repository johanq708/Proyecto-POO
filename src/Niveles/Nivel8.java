 ...
 */
public class Nivel8 extends Tablero{
    private Obstaculo obstaculo81;
    private Obstaculo obstaculo82;

    public Nivel8() {
        bala=new Bala(20,390,50,50);
        blanco=new Blanco(1100,200,64,44,bala);
        puntuacion=new Puntuacion(blanco);
        this.obstaculo81 = new Obstaculo(800,150,82,100,bala);
        this.obstaculo82 = new Obstaculo(400,200,140,140,bala);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawImage(muro, obstaculo82.getX(), obstaculo82.getY(),obstaculo82.getAncho(),obstaculo82.getAlto(),this);
        g.drawImage(muro, obstaculo81.getX(), obstaculo81.getY(),obstaculo81.getAncho(),obstaculo81.getAlto(), this);
        dibujar(g,0,0);
    }    
    ...
    public void actionPerformed(ActionEvent e) {
        bala.disparar();
        blanco.punteria();
        obstaculo81.punteria();
        obstaculo82.punteria();
        puntuacion.darpuntos();
        cambiar();
        repaint();
    }    
    public void cambiar(){
        if(blanco.isDiob()==true||blanco.isDiom()==true||blanco.isNodio()==true||obstaculo81.isNodio()==true||obstaculo82.isNodio()){
            this.cambio=true;
        }
    }
}
