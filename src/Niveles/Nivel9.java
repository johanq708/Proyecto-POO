 ...
 * @author johit
 */
public class Nivel9 extends Tablero{
    
    private Obstaculo obstaculo91;
    private Obstaculo obstaculo92;
    private Movible obstaculo93;

    public Nivel9(){
        bala=new Bala(20,390,50,50);
        blanco=new Blanco(900,350,64,44,bala);
        puntuacion=new Puntuacion(blanco);
        this.obstaculo91 = new Obstaculo(200,250,100,100,bala);
        this.obstaculo92 = new Obstaculo(500,200,100,140,bala);
        this.obstaculo93 = new Movible(200,220,82,100,bala);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawImage(muro, obstaculo92.getX(), obstaculo92.getY(),obstaculo92.getAncho(),obstaculo92.getAlto(),this);
        g.drawImage(muro, obstaculo91.getX(), obstaculo91.getY(),obstaculo91.getAncho(),obstaculo91.getAlto(), this);
        g.drawImage(obstaculo, obstaculo93.getX(), obstaculo93.getY(),obstaculo93.getAncho(),obstaculo93.getAlto(),obstaculo93.getS(),0,obstaculo93.getS()+182,150, this);
        dibujar(g,0,0);
    }    
    ...
    public void actionPerformed(ActionEvent e) {
        bala.disparar();
        blanco.punteria();
        obstaculo91.punteria();
        obstaculo92.punteria();
        obstaculo93.mover();
        obstaculo93.punteria();
        puntuacion.darpuntos();
        cambiar();
        repaint();
    }    
    public void cambiar(){
        if(blanco.isDiob()==true||blanco.isDiom()==true||blanco.isNodio()==true||obstaculo91.isNodio()==true||obstaculo92.isNodio()){
            this.cambio=true;
        }
    }
}
