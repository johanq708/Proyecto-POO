 ...
 * @author johit
 */
public class Nivel3 extends Tablero{
    ...
    public Nivel3() {
        ...
        this.obstaculo3 = new Obstaculo(400,200,140,140,bala);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        Image obstaculo = loadImage("muro.jpg");
        ...
        g.drawImage(obstaculo, obstaculo3.getX(), obstaculo3.getY(),obstaculo3.getAncho(),obstaculo3.getAlto(), this);
        dibujar(g,0,0);
    }    
    ...
    public void cambiar(){
        if(blanco.isDiob()==true||blanco.isDiom()==true||blanco.isNodio()==true||obstaculo3.isNodio()==true){
            this.cambio=true;
        }
    }    
}
