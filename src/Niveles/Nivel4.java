...
public class Nivel4 extends Tablero{
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawImage(muro, obstaculo4.getX(), obstaculo4.getY(),obstaculo4.getAncho(),obstaculo4.getAlto(), this);
        dibujar(g,200,220);
    }
    ...
    public void cambiar(){
        if(blanco.isDiob()==true||blanco.isDiom()==true||blanco.isNodio()==true||obstaculo4.isNodio()==true){
            this.cambio=true;
        }
    }    
}
