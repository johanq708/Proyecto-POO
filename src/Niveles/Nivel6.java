 ...
 */
public class Nivel6 extends Tablero{
    private Movible obstaculo61;
    private Obstaculo obstaculo62;

    public Nivel6() {
        bala=new Bala(20,390,50,50);
        blanco=new Blanco(1100,200,64,44,bala);
        puntuacion=new Puntuacion(blanco);
        this.obstaculo61 = new Movible(400,150,82,100,bala);
        this.obstaculo62 = new Obstaculo(400,200,140,140,bala);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawImage(muro, obstaculo62.getX(), obstaculo62.getY(),obstaculo62.getAncho(),obstaculo62.getAlto(),this);
        g.drawImage(obstaculo, obstaculo61.getX(), obstaculo61.getY(),obstaculo61.getAncho(),obstaculo61.getAlto(),obstaculo61.getS(),0,obstaculo61.getS()+182,150, this);
        dibujar(g,0,0);
    }    
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        obstaculo61.mover();
        blanco.punteria();
        obstaculo61.punteria();
        obstaculo62.punteria();
        puntuacion.darpuntos();
        cambiar();
        repaint();
    }    
    public void cambiar(){
        if(blanco.isDiob()==true||blanco.isDiom()==true||blanco.isNodio()==true||obstaculo61.isNodio()==true||obstaculo62.isNodio()){
            this.cambio=true;
        }
    }
}
